          ...
          >
            ...
            <div className="space-y-4">
              <a
                ...
                className="glass-card p-5 rounded-2xl flex items-center gap-5 hover:border-primary/40 group transition-all premium-border block"
              >
              ...
              <a
                href="#"
                className="glass-card p-5 rounded-2xl flex items-center gap-5 hover:border-secondary/40 group transition-all premium-border block"
              >
